...
def save_images(image_floder_name, image_name, location1=[], location2=[]):
    ...
    Image_width=64
    Image_height=32
    bbox_red = (x1, y1, x1 + Image_width, y1 + Image_height)
    ...
    # --- 3. 处理蓝色区域 (Location 2) ---
    x2, y2 = location2
    bbox_blue = (x2, y2, x2 + Image_width, y2 + Image_height)
...
image_floder_name = 'SDSD_indoor-resized'
...
for image_name in file_names:
    ...
    save_images(image_floder_name, image_name[:-4], location1 = [235,210], location2=[380,208])
